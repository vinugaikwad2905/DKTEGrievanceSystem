...
<div class = "container w-50 border rounded-3 mt-5 mb-5 p-3">
    ...
    <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">Rejected Reason</label>
        <textarea type="text" class="form-control" id="exampleFormControlInput1" placeholder="" name = "exampleFormControlInput1" rows="7" disabled><?php $temp = $_GET['solution'];echo $temp; ?></textarea> 
    </div>
</div>
